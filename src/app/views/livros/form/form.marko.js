// Compiled using marko@4.13.4-4 - DO NOT EDIT
"use strict";
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1><form action=\"/livros\" method=\"POST\"><input type=\"hidden\" id=\"id\" name=\"id\"><div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"Título\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" placeholder=\"Preço\"></div><div><label for=\"descricao\">Descrição:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"Título\"></textarea></div><input type=\"submit\" value=\"Salvar\"></form>");
